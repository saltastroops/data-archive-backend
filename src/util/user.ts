...
JOIN admin.proposal_access_rule par ON pi.proposal_id = par.proposal_id
...
WHERE pi.institution_user_id=$1 AND i.abbreviated_name=$2 AND a.artifact_id = ANY($3) AND (ar.access_rule=$4 OR ar.access_rule=$5)
  `;
